...
1. Unzip this file
2. Move the `sprint-planning-assistant` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `sprint-planning-assistant` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/sprint-planning-assistant)
