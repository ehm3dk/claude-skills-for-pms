...
- Can someone understand what a unit does without reading its internals? Can you change the internals without breaking consumers? If no, the boundaries need work.
...
1. Dispatch spec-document-reviewer subagent with precisely crafted review context — never your session history
