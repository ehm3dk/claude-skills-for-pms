...
1. Unzip this file
2. Move the `feature-decomposition-tool` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `feature-decomposition-tool` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/feature-decomposition-tool)
