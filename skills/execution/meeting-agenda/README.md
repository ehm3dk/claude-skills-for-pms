...
1. Unzip this file
2. Move the `meeting-agenda` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `meeting-agenda` folder to `~/.claude/skills/`
...
→ [Full documentation](https://mysecond.ai/skills/meeting-agenda)
