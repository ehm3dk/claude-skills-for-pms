...
4. **Understand Dependencies** - What settings, config, environment does it assume?
...
1. **Create Failing Test Case** - Use superpowers:test-driven-development for writing proper failing tests
